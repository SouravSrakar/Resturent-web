                ...
                <!-- Brand and toggle get grouped for better mobile display -->
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav main-nav  clear navbar-right ">
                            ...
                            <li><a class="color_animation" href="website-8/index.php">MENU</a></li>
                            ...
                            <?php
                            if(empty($_SESSION['ses_user'])){
                            echo '<li><a class="color_animation" href="login/">LOGIN</a></li>';
                            }?>
                            <?php
                            if(empty($_SESSION['ses_user'])){
                            echo '<li><a class="color_animation" href="ADMIN/ADMIN_LOGIN/">ADMIN LOGIN</a></li>';
                            }?>
                        </ul>
                    </div><!-- /.navbar-collapse -->
                </div>
            ...
            <div class="follow_container">
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <h2 class="white second-title">" Best in the city "</h2>
    	             ...
    	             <p><h2 class="white second-title"> Welcome <strong>
                        <?php
